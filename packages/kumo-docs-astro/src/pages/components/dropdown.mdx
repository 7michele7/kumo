...
<Heading level={3}>Long Lists with Scrolling</Heading>
<p>
  When a dropdown contains many items, the popup automatically constrains to the
  available viewport space and scrolls internally. This works on both desktop
  and touch devices.
</p>
